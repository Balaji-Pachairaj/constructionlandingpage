...
const projects = [
     {
          image: "https://tse3.mm.bing.net/th?id=OIP.etp3UJOoKAxBWfitTb_7GgHaFj&pid=Api&P=0&h=180",
     },
     {
          image: "https://tse3.mm.bing.net/th?id=OIP.q4r8tmw9G4BV0crhmhnlkgHaEK&pid=Api&P=0&h=180",
     },
     {
          image: "https://tse2.mm.bing.net/th?id=OIP.BMA3OuNA6rsSbxZBQuiuPQHaEn&pid=Api&P=0&h=180",
     },
     {
          image: "https://tse4.mm.bing.net/th?id=OIP.h_5RBX8Ew9v8y6eO77ToqAAAAA&pid=Api&P=0&h=180",
     },
     {
          image: "https://tse3.mm.bing.net/th?id=OIP.Lc3AFMtr9ctaE20zDGAIpgAAAA&pid=Api&P=0&h=180",
     },
     {
          image: "https://tse3.mm.bing.net/th?id=OIP.57SEBrZYuQXcRPk0Cq4kdQHaFj&pid=Api&P=0&h=180",
     },
];
                    ...
                    <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center h-full gap-[1rem]">
                         ...
                         <div className="md:w-[45%] text-center md:text-left mb-8 md:mb-0 flex flex-col justify-center gap-[2rem] h-full">
                              <h1 className="text-4xl font-bold text-blue-600 mb-4">
                                   Building Your Dreams, <br></br> One Project
                                   at a Time
                              </h1>
                              <p className="text-lg text-gray-700 mb-6">
                                   At Construction Co., we are dedicated to
                                   delivering high-quality construction services
                                   that exceed your expectations. With years of
                                   experience and a team of skilled
                                   professionals, we bring your vision to life
